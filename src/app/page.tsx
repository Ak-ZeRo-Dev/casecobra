...
import palestine_case from "../../public/palestine_case.jpg";
...
export default function Home() {
  const stars = Array.from({ length: 5 }).map((_, index) => (
    <Star
      key={index}
      className="h-4 w-4 shrink-0 text-green-600 fill-green-600"
    />
  ));
        ...
        <MaxWidthWrapper className="pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52">
          ...
          <div className="col-span-full lg:col-span-1 w-full flex justify-center px-8 sm:px-16 md:px-0 mt-32 lg:mx-0 lg:mt-20 h-fit">
            <div className="relative md:max-w-xl">
              ...
              />
              <Phone
                imgSrc={palestine_case as unknown as string}
                className="w-64"
              />
            </div>
          </div>
      ...
      <section className="bg-slate-100 grainy-dark py-24">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-32">
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
            {reviews.map(({ name, review, image }, index) => (
              <div
        ...
        <MaxWidthWrapper className="py-24">
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="relative flex flex-col items-center md:grid grid-cols-2 gap-40">
              ...
              />
              <div className="relative h-80 md:h-fit w-full md:justify-self-end max-w-sm rounded-xl bg-gray-900/5 ring-inset ring-gray-900/10 lg:rounded-2xl">
                <Image
                  src={palestine}
                  alt="natural"
              ...
              <Phone imgSrc={palestine_case as unknown as string} />
            </div>
          </div>
